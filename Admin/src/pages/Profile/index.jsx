...
import { editData, postData, uploadImage } from '../../../Utlis/Api';
...
const onChangeFile = async (e, apiEndPoint) => {
  ...
  return (
   ...
   <div className="flex items-center justify-between"> 
     <h2 className="text-[18px] font-[600]">User Profile
        </h2>
        ...
        <div className="w-[90px] md:w-[110px] h-[90px] md:h-[110px] rounded-full overflow-hidden !mb-3 relative group flex items-center justify-center bg-gray-200">
              ...
              <div className="flex items-center gap-5">
                <div className="w-[50%]">
                          <input
                type="text"
                className="w-full h-[40px] border border-[rgba(0,0,0,0.2)] focus:outline-none focus:border-[rgba(0,0,0,0.5)] rounded-md p-3 text-sm bg-[#fafafa]" name="name" value={formFields.name}
                    disabled={isLoading}
              ...
              />
                ...
                <div className="w-[50%]">
                    <input
                type="email"
                className="w-full h-[40px] border border-[rgba(0,0,0,0.2)] focus:outline-none focus:border-[rgba(0,0,0,0.5)] rounded-md p-3 text-sm bg-[#fafafa]" name="email"
      ...
      />
                ...
                <div className="flex items-center justify-center p-5 border border-dashed border-[rgba(0,0,0,0.2)] bg-[#f1faff] cursor-pointer hover:bg-[#e1f1ff]"  onClick={()=>context.setIsOpenFullScreenPanel({
                  open:true,
